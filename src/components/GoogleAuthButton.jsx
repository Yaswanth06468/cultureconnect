...
const DEFAULT_CLIENT_ID = "1086202476536-googleclientid.apps.googleusercontent.com"; // Replace with your Google Cloud OAuth Client ID
...
const GoogleAuthButton = ({ onSuccess, onError, buttonText = "Sign up with Google" }) => {
    ...
    return (
        <div className="w-full flex flex-col items-center gap-2">
            {/* Real Official Google Sign-In Rendered Button Container */}
            <div 
                ref={googleButtonRef} 
                className="w-full flex justify-center min-h-[44px]"
            ></div>

            {/* Fallback Trigger Button if renderButton is initializing */}
            <button
                type="button"
