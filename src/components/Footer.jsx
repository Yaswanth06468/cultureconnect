...
const Footer = () => {
    return (
        <footer className="py-20 bg-[#07070b] border-t border-white/10 text-white relative">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-2">
                        <Link
                            to="/"
                            className="text-2xl font-serif font-black tracking-tight mb-4 inline-block text-white group"
                        >
                            CULTURE<span className="text-[#0ff0a0]">CONNECT</span>
                        </Link>
                        <p className="max-w-sm mb-8 font-light leading-relaxed text-zinc-400">
                ...
                <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-medium uppercase tracking-wider text-zinc-500">
                    <div className="flex items-center gap-2">
                        <p>&copy; 2026 CultureConnect.</p>
                        <span>|</span>
                        <p className="flex items-center gap-1">
                            Made with <span className="text-[#ff5e62] animate-pulse text-sm">♥</span> by <span className="text-white font-bold ml-1">Yaswanth</span>
                        </p>
                    </div>
