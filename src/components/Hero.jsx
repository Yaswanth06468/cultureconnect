...
const Hero = () => {
    return (
        <section className="relative min-h-[92vh] flex items-center pt-8 pb-16 overflow-hidden bg-[#0a0a0f]">
            ...
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="order-2 md:order-1 animate-slide-left">
                    <div className="mb-6 inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 backdrop-blur-md">
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-black mb-6 leading-[1.05] text-white">
                        Connect Through <br />
                    ...
                    <p className="text-lg md:text-xl max-w-lg mb-10 leading-relaxed font-light text-zinc-400">
                    ...
                    <div className="flex flex-col sm:flex-row gap-5">
                        ...
                        <a
                            href="#about"
                            className="px-8 py-4 font-bold transition-all duration-300 text-center text-zinc-300 hover:text-white rounded-full border border-white/15 hover:border-white/40 bg-white/5 hover:bg-white/10 backdrop-blur-md"
                        >
                            Our Mission
                        </a>
                    </div>
                ...
                <div className="relative order-1 md:order-2 h-[45vh] md:h-[75vh] w-full flex items-center justify-center">
                    <div className="w-full h-full overflow-hidden rounded-3xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.8)] relative group">
                        <img
                            src="/hero_dark.png"
