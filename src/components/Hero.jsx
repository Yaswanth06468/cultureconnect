            ...
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="order-2 md:order-1 animate-slide-left">
                    ...
                    <div className="flex flex-col sm:flex-row gap-5">
                        ...
                        <a
                            href="#about"
                            className="px-8 py-4 font-bold transition-all duration-300 text-center text-[var(--theme-text-secondary)] hover:text-[var(--theme-text-primary)] rounded-full border border-[var(--theme-border)] hover:border-[var(--theme-text-muted)] bg-[var(--theme-card-bg)] backdrop-blur-md"
                        >
                            Our Mission
                        </a>
                    </div>
                ...
                <div className="relative order-1 md:order-2 h-[45vh] md:h-[75vh] w-full flex items-center justify-center">
                    <div className="w-full h-full overflow-hidden rounded-3xl border border-[var(--theme-border)] shadow-[0_25px_60px_var(--theme-shadow)] relative group">
                        <img
                            src="/hero_dark.png"
